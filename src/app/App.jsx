...
const songzhuangWords = [
  ['线', 56, 16, 0.9, 'deep'], ['编织', 69, 18, 0.7, 'deep'], ['记忆', 87, 30, 0.75, 'deep'],
  ['竹片', 41, 39, 0.35, 'mid'], ['彩带', 52, 47, 0.5, 'mid'], ['手', 57, 55, 0.85, 'deep'],
  ['使用', 43, 53, 0.25, 'soft'], ['赠送', 48, 65, 0.42, 'mid'], ['信物', 61, 66, 0.72, 'deep'],
  ['婚嫁', 79, 48, 0.52, 'mid'], ['关系', 90, 60, 0.8, 'deep'], ['相遇', 70, 74, 0.62, 'mid'],
  ['畲歌', 44, 73, 0.3, 'soft'], ['对唱', 54, 84, 0.32, 'soft'], ['讲述', 83, 81, 0.32, 'soft'],
  ['下一代', 63, 91, 0.26, 'soft'], ['变化', 91, 42, 0.22, 'soft'], ['继续', 41, 90, 0.26, 'soft'],
]
