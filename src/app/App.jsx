...
const songzhuangWords = [
  ['线', 78, 69, 0.9, 'deep'], ['编织', 86, 74, 0.7, 'deep'], ['记忆', 88, 31, 0.75, 'deep'],
  ['竹片', 34, 42, 0.35, 'mid'], ['彩带', 49, 48, 0.5, 'mid'], ['手', 55, 54, 0.85, 'deep'],
  ['使用', 39, 57, 0.25, 'soft'], ['赠送', 43, 69, 0.42, 'mid'], ['信物', 56, 72, 0.72, 'deep'],
  ['婚嫁', 61, 89, 0.52, 'mid'], ['关系', 91, 58, 0.8, 'deep'], ['相遇', 73, 80, 0.62, 'mid'],
  ['畲歌', 36, 78, 0.3, 'soft'], ['对唱', 47, 88, 0.32, 'soft'], ['讲述', 88, 82, 0.32, 'soft'],
  ['下一代', 68, 91, 0.26, 'soft'], ['变化', 93, 43, 0.22, 'soft'], ['继续', 82, 94, 0.26, 'soft'],
]
