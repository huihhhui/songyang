...
const songzhuangWords = [
  ['线', 58, 31, 0.9, 'deep'], ['编织', 68, 31, 0.7, 'deep'], ['记忆', 78, 44, 0.75, 'deep'],
  ['竹片', 48, 42, 0.35, 'mid'], ['彩带', 60, 44, 0.5, 'mid'], ['手', 67, 55, 0.85, 'deep'],
  ['使用', 52, 56, 0.25, 'soft'], ['赠送', 57, 64, 0.42, 'mid'], ['信物', 69, 66, 0.72, 'deep'],
  ['婚嫁', 82, 59, 0.52, 'mid'], ['关系', 88, 70, 0.8, 'deep'], ['相遇', 75, 76, 0.62, 'mid'],
  ['畲歌', 48, 72, 0.3, 'soft'], ['对唱', 59, 82, 0.32, 'soft'], ['讲述', 83, 82, 0.32, 'soft'],
  ['下一代', 70, 88, 0.26, 'soft'], ['变化', 92, 54, 0.22, 'soft'], ['继续', 85, 90, 0.26, 'soft'],
]
