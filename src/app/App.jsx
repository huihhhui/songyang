...
const songzhuangWords = [
  ...
  ['竹片', 41, 43, 0.35, 'mid'], ['彩带', 52, 51, 0.5, 'mid'], ['手', 57, 59, 0.85, 'deep'],
  ['使用', 43, 58, 0.25, 'soft'], ['赠送', 48, 70, 0.42, 'mid'], ['信物', 61, 71, 0.72, 'deep'],
  ['婚嫁', 79, 57, 0.52, 'mid'], ['关系', 90, 67, 0.8, 'deep'], ['相遇', 72, 80, 0.62, 'mid'],
  ['畲歌', 44, 78, 0.3, 'soft'], ['对唱', 57, 88, 0.32, 'soft'], ['讲述', 86, 81, 0.32, 'soft'],
  ['下一代', 72, 92, 0.26, 'soft'], ['变化', 91, 42, 0.22, 'soft'], ['继续', 41, 90, 0.26, 'soft'],
]
