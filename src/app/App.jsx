...
const songzhuangWords = [
  ['线', 47, 30, 0.9, 'deep'], ['编织', 58, 35, 0.7, 'deep'], ['记忆', 72, 48, 0.75, 'deep'],
  ['竹片', 28, 48, 0.35, 'mid'], ['彩带', 49, 43, 0.5, 'mid'], ['手', 48, 61, 0.85, 'deep'],
  ['使用', 18, 60, 0.25, 'soft'], ['赠送', 31, 70, 0.42, 'mid'], ['信物', 54, 76, 0.72, 'deep'],
  ['婚嫁', 71, 63, 0.52, 'mid'], ['关系', 84, 73, 0.8, 'deep'], ['相遇', 66, 84, 0.62, 'mid'],
  ['畲歌', 18, 80, 0.3, 'soft'], ['对唱', 31, 88, 0.32, 'soft'], ['讲述', 78, 88, 0.32, 'soft'],
  ['下一代', 51, 91, 0.26, 'soft'], ['变化', 91, 58, 0.22, 'soft'], ['继续', 73, 95, 0.26, 'soft'],
]
