...
const songzhuangWords = [
  ['线', 47, 22, 0.9, 'deep'], ['编织', 61, 27, 0.7, 'deep'], ['记忆', 77, 36, 0.75, 'deep'],
  ['竹片', 28, 35, 0.35, 'mid'], ['彩带', 45, 34, 0.5, 'mid'], ['手', 49, 49, 0.85, 'deep'],
  ['使用', 19, 49, 0.25, 'soft'], ['赠送', 29, 60, 0.42, 'mid'], ['信物', 54, 62, 0.72, 'deep'],
  ['婚嫁', 72, 53, 0.52, 'mid'], ['关系', 83, 63, 0.8, 'deep'], ['相遇', 65, 73, 0.62, 'mid'],
  ['畲歌', 22, 73, 0.3, 'soft'], ['对唱', 36, 81, 0.32, 'soft'], ['讲述', 77, 79, 0.32, 'soft'],
  ['下一代', 50, 84, 0.26, 'soft'], ['变化', 89, 47, 0.22, 'soft'], ['继续', 70, 90, 0.26, 'soft'],
]
